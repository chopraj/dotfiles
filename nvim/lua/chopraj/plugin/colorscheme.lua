return {
  ...
  },
  {
    ...
    config = function()
      ...
      -- Uncomment the line below to enable gruvbox-material theme
  ...
  },
  {
    ...
    priority = 1000,
    config = function()
      -- Uncomment the line below to enable forest-night theme
  ...
  },
  {
    ...
    enabled = false,
    config = function()
      -- Uncomment the line below to enable base16-ayu-mirage theme
